...
@Component
public class RealTimeFencingClient {

    private WebClient.Builder webClientBuilder;

    public RealTimeFencingClient(@Qualifier("loadBalancedClient") WebClient.Builder loadBalancedWebClientBuilder,
    ...
    public Mono<String> defineFenceForMover(FenceDto fenceDto) {
        return webClientBuilder
                .build()
                .post()
                .uri("http://realtime-fencing/api/fences")
                .bodyValue(fenceDto)
                .retrieve()
