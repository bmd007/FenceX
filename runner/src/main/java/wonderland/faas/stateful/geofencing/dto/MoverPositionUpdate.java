...
@JsonDeserialize(builder = MoverPositionUpdate.Builder.class)
public class MoverPositionUpdate {
    ...
    private MoverPositionUpdate(Builder builder) {
    ...
    public static Builder newBuilder(MoverPositionUpdate copy) {
    ...
    public boolean equals(Object o) {
        ...
        MoverPositionUpdate that = (MoverPositionUpdate) o;
    ...
    public static final class Builder {
        ...
        public MoverPositionUpdate build() {
            return new MoverPositionUpdate(this);
        }
    }
}
