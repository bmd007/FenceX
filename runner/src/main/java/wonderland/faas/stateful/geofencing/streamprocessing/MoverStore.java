...
public class MoverStore implements KeyValueStore<String, Mover> {
    ...
    public MoverStore(String name, MoverRepository repository) {
        this.name = name;
        ...
        if (root != null) {
            ...
            context.register(root, (keyBytes, valueBytes) -> {
                ...
                if (valueBytes == null) {
                    ...
                    var value = CustomSerdes.MOVER_JSON_SERDE.deserializer().deserialize(null, valueBytes);
                    put(key, value);
                }
            });
        }
    ...
    public Mover putIfAbsent(String key, Mover value) {
        LOGGER.debug("Updating {} if absent", key);
    ...
    public static class Builder extends AbstractStoreBuilder<String, Mover, MoverStore> {
        ...
        public Builder(String name, Time time, MoverRepository repository) {
