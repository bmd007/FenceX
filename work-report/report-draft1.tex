...
\begin{document}
    ...
    We can just have a look at corresponding graphs during execution of test scenarion.

    \subsection{Push leg}
    Firstly, we define fences for movers using all the trips in the bench-marking application database.
    Then we sent a socking stream of location reports into the system.
    We have graphs prodcued that show the total number of intersections happening in push leg of system.
