...
\begin{document}
    ...
    GeoJson is JSON friendly, GML is of XML nature, WKB is in bytes and WKT is basically plain text.
    So comparison of GeoJson and GML is similar to comparison of JSON and XML.
    Also, Comparison of WKB and WKT is similar to comparison of plain text and representing that text as bytes.
    All other members of comparison space here can be dealt with in the same way.
    Libraries and database engines supporting geospatial data and operations, usually support only one or some of these
