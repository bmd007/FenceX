...
%todo check the sections
%    todo bench-marking all over the place,, no benchmarking
    ...
    \section{Benchmarking application}
    ...
    \end{itemize}
%    todo repeat the experiment group name in the expriment title
...
%spell checking and talk how tolerance is checkd here
