...
\begin{document}
    ...
    \begin{figure}[ht]
        ...
        \includegraphics[scale=0.2]{images/Infrsutracture.png}
    \end{figure}
    ...
    \begin{itemize}
        \item[1-] We defined fences for movers using all the trips in the bench-marking application database.
        \item[2-] We sent a many location updates to FenceX.
        \item[2-] We sent a shocking load queries (query by fence) to FenceX.
        \item[3-] We checked the throughput.
        \item[4-] Repeat the experiment after changing the deployment configuration. (Maybe add more instances or add
    ...
    \begin{itemize}
        \item[1-] We defined fences for movers using all the trips in the bench-marking application database.
        \item[2-] We start an ongoing stream of location report toward FenceX.
        \item[3-] We wait until throughput becomes stable.
        \item[4-] We restart on of the instances of realtime-fencing.
        \item[5-] We assert that throughput drops.
        \item[6-] We wait until successful re-balancing.
        \item[7-] We assert that throughput is back to previous value.
        \item[8-] We repeat the experiment with difference of restarting two instances instead of one.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item[2-] We start an ongoing load of queries (query by fence) to FenceX.
        \item[3-] We wait until throughput becomes stable.
        \item[4-] We restart on of the instances of location-aggregate.
        \item[5-] We assert that throughput drops.
        \item[6-] We wait until successful re-balancing.
        \item[7-] We assert that throughput is back to previous value.
        \item[8-] We repeat the experiment with difference of restarting two instances instead of one.
    ...
    second)
    and the yellow line shows the rate of queries answered successfully.
