...
\begin{document}
    ...
    deployed as instances of microservices containing stream processing pipe line tasks.
    ...
    The order at which events arrive to next operator matters so usually in stream processing systems, a publish
    subscribe pattern is an action which is implemented using some sort of queue, journal, commit log or topic.
