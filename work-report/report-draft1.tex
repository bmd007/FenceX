...
\begin{document}
    ...
    Our contribution is design, implementation and evaluation of a geofencing system which relies on stream
    processing and microservice in order to achieve high throughput, high scalability and high availabilty.
    ...
    Our work, apart from being a geofencing system, is an implmentaion for the idea of FAAS which supports stateful
    operations as well.
    ...
    In \cite{Cirillo-Jacobs-Martin-Szczytowski-2014}, a poll style on demand geofencing system is introduced that
