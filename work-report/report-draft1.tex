...
\begin{document}
    ...
    In this thesis we have designed and implemented a geofencing system called FenceX \cite{fencex} with those needs in mind;
...
%    write what is funtional requirement  first....
...
%all the info is in the next sections and add reference
    ...
    Since FenceX needs that complied version of Functions, they can be implemented in any JVM language as far as they
    can be compiled into a Java class (Java byte code).
%    todo For example Kotlin
...
%todo re arrange the section/subsection
    ...
    \subsubsection{Pull leg throughput}
...
%        \centering
        ...
        \includegraphics[scale=0.5]{images/evaluation/ex1-benchmarking(15,6).png}
    \end{sidewaysfigure}

    \begin{sidewaysfigure}[h!]
        \caption{FenceX push throughput ex1-2}
        \label{fig:ex1-2}
        \includegraphics[scale=0.5]{images/evaluation/ex1-benchmarking(19,7).png}
    \end{sidewaysfigure}

    \begin{sidewaysfigure}[h!]
        \caption{FenceX push throughput ex1-3}
        \label{fig:ex1-3}
        \includegraphics[scale=0.5]{images/evaluation/ex1-benchmarking(22,9).png}
    \end{sidewaysfigure}

    \begin{sidewaysfigure}[h!]
        \caption{FenceX push throughput ex1-4}
        \label{fig:ex1-4}
        \includegraphics[scale=0.5]{images/evaluation/ex1-benchmarking(23,10).png}
    \end{sidewaysfigure}
    ...
    \begin{sidewaysfigure}[h!]
        ...
        \label{fig:ex2}
        \includegraphics[scale=0.5]{images/evaluation/ex2-benchmarking(24,10).png}
    \end{sidewaysfigure}
    ...
    \begin{sidewaysfigure}[h!]
        ...
        \label{fig:ex4-1}
        \includegraphics[scale=0.5]{images/evaluation/ex4-benchmarking(19,10).png}
    \end{sidewaysfigure}

    \begin{sidewaysfigure}[h!]
        \caption{FenceX pull throughput ex4-2}
        \label{fig:ex4-2}
        \includegraphics[scale=0.5]{images/evaluation/ex4-benchmarking(22,10).png}
    \end{sidewaysfigure}
    ...
    \begin{sidewaysfigure}[h!]
        ...
        \label{fig:ex5-2}
        \includegraphics[scale=0.5]{images/evaluation/ex5-benchmarking-ongoing-2per7sec.png}
    \end{sidewaysfigure}
    ...
    \begin{sidewaysfigure}[h!]
        ...
        \label{fig:ex24}
        \includegraphics[scale=0.5]{images/evaluation/ex24-benchmarking-ongoing-1per2sec.png}
    \end{sidewaysfigure}
