...
\begin{document}
    ...
    These numbers are selected corresponding to available resources to the overall system.
    ...
    \subsection{Push leg}
    Push throughput experiments process:
    \begin{itemize}
    ...
    \subsection{Poll leg}
    Poll throughput experiments process:
    \begin{itemize}
        \item[1-] Define fences for movers using all the trips in the bench-marking application database.
    ...
    \subsection{Push leg}
    Push leg availability experiments process:
    \begin{itemize}
        \item[1-] Define fences for movers using all the trips in the bench-marking application database.
    ...
    \subsection{Poll leg}
    Poll leg availability experiments process:
    \begin{itemize}
    ...
    \subsection{Push leg}
    Push leg strong scalability experiments process:
    \begin{itemize}
        \item[1-] Define fences for movers using all the trips in the bench-marking application database.
    ...
    \subsection{Poll leg}
    Poll leg strong scalability experiments process:
    \begin{itemize}
    ...
    \subsection{Push leg}
    Push leg weak scalability experiments process:
    \begin{itemize}
        \item[1-] Define fences for movers using all the trips in the bench-marking application database.
    ...
    \subsection{Poll leg}
    Poll leg weak scalability experiments process:
    \begin{itemize}
    ...
    \subsection{Push leg}
    Push leg free fall scalability experiment process:
    \begin{itemize}
    ...
    In this section we will go over a couple of papers which has introduced a geofencing systems.
