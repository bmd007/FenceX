...
\begin{document}
    ...
    The following figure illustrates how input rate and throughput have changed during those experiments.
    ...
    \begin{sidewaysfigure}[h!]
        ...
        \begin{subfigure}[b]{\textwidth}
            ...
            \label{fig:ex8}
            \includegraphics[width=\textwidth, height=0.3\textheight, scale=2]{images/evaluation/ex8-benchmarking-ongoing-2per4sec.png}
        \end{subfigure}
        ...
        \begin{subfigure}[b]{\textwidth}
            ...
            \label{fig:ex9}
            \includegraphics[width=\textwidth, height=0.3\textheight, scale=2]{images/evaluation/ex9-benchmarking-ongoing-2per4sec.png}
        \end{subfigure}
    \end{sidewaysfigure}
    ...
    \begin{sidewaysfigure}[h!]
        ...
        \begin{subfigure}[b]{\textwidth}
            ...
            \label{fig:ex10}
            \includegraphics[width=\textwidth, height=0.3\textheight, scale=2]{images/evaluation/ex10-benchmarking-ongoing-2per4sec.png}
        \end{subfigure}
        ...
        \begin{subfigure}[b]{\textwidth}
            ...
            \label{fig:ex11}
            \includegraphics[width=\textwidth, height=0.3\textheight, scale=2]{images/evaluation/ex11-benchmarking-ongoing-2per4sec.png}
        \end{subfigure}
    \end{sidewaysfigure}
    ...
    \begin{sidewaysfigure}[h!]
        ...
        \begin{subfigure}[b]{\textwidth}
            ...
            \label{fig:ex17}
            \includegraphics[width=\textwidth, height=0.3\textheight, scale=2]{images/evaluation/ex17-benchmarking-ongoing-2per4sec.png}
        \end{subfigure}
        ...
        \begin{subfigure}[b]{\textwidth}
            ...
            \label{fig:ex18}
            \includegraphics[width=\textwidth, height=0.3\textheight, scale=2]{images/evaluation/ex18-benchmarking-ongoing-2per4sec.png}
        \end{subfigure}
    \end{sidewaysfigure}
