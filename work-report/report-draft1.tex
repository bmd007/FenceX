...
\begin{document}
    ...
    Also in \ref{fig:ex10} we can see the effect of buffered location updates on throughput.
    ...
    We did not increase the input rate in experiment 11 (as we shouldn't due to strong scalability test scenario) so
    we did not expect a higher throughput in experiment 11.
