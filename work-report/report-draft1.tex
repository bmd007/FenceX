...
\begin{document}
    ...
    Apart from being a geofencing system, FenceX can be considered an implementation for the idea of statul function
    as a service.
    ...
    Also my reviwer, Sadi Alawadi, whose feedback was necessary to stay relevant.
