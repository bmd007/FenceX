...
\begin{document}
    ...
    \subsection{Using Complex Event Processing for implementing a geofencing service, 2013 \cite{Târnaucă_Puiu_Nechifor_Comnac_2013}
    ...
    Evaluations have shown that it can has acheived throughput of around 20k/s.
