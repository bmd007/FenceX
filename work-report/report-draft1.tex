...
\begin{document}
    ...
    \section{Evalution of pure throughput}
    ...
    deployed in addition to the amount of resources we have assigned to each microservice instance.
    The row in \ref{table:ex1-dv} with no values corresponds to a microservice which does not relate to the 
    experiment 1. 
    ...
    The row in \ref{table:ex2-dv} with no values corresponds to a microservice which does not relate to the
    experiment 2.
    After successful deployment, we followed the previously mentioned scenario.
    ...
    \subsubsection{Conclusion of pure throughput evaluation}
    ...
    deployed in addition to the amount of resources we have assigned to each microservice instance.
    The row in \ref{table:ex3-dv} with no values corresponds to a microservice which does not relate to the
    experiment 3.
    ...
    The row in \ref{table:ex4-dv} with no values corresponds to a microservice which does not relate to the
    experiment 4.
    ...
    deployed in addition to the amount of resources we have assigned to each microservice instance.
    The row in \ref{table:ex5-dv} with no values corresponds to a microservice which does not relate to the
    experiment 5.
    ...
    deployed in addition to the amount of resources we have assigned to each microservice instance.
    The row in \ref{table:ex7-dv} with no values corresponds to a microservice which does not relate to the
    experiment 7.
    ...
    deployed in addition to the amount of resources we have assigned to each microservice instance.
    The row in \ref{table:ex8-dv} with no values corresponds to a microservice which does not relate to the
    experiment 8.
    ...
    The row in \ref{table:ex9-dv} with no values corresponds to a microservice which does not relate to the
    experiment 9.
    ...
    The row in \ref{table:ex10-dv} with no values corresponds to a microservice which does not relate to the
    experiment 10.
    ...
    The row in \ref{table:ex11-dv} with no values corresponds to a microservice which does not relate to the
    experiment 11.
    ...
    initially deployed in addition to the amount of resources we have assigned to each microservice instance.
    The row in \ref{table:ex17-dv} with no values corresponds to a microservice which does not relate to the
    experiment 17.
    ...
    The row in \ref{table:ex18-dv} with no values corresponds to a microservice which does not relate to the
    experiment 18.
    ...
    initially deployed in addition to the amount of resources we have assigned to each microservice instance.
    The row in \ref{table:ex19-dv} with no values corresponds to a microservice which does not relate to the
    experiment 19.
    ...
    The row in \ref{table:ex20-dv} with no values corresponds to a microservice which does not relate to the
    experiment 20.
    ...
    The row in \ref{table:ex21-dv} with no values corresponds to a microservice which does not relate to the
    experiment 21.
    ...
    The row in \ref{table:ex22-dv} with no values corresponds to a microservice which does not relate to the
    experiment 22.
    ...
    The row in \ref{table:ex23-dv} with no values corresponds to a microservice which does not relate to the
    experiment 23.
    ...
    The row in \ref{table:ex24-dv} with no values corresponds to a microservice which does not relate to the
    experiment 24.
    ...
    A push style realtime geofencing system has been intoduced in \cite{Nechifor_Comnac_2013}.
