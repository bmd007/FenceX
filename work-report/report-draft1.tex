...
\begin{document}
    ...
    In this thesis we used WKT to represent all the invovled gepspatial data.
    ...
    \section{Nonfunctional characteristics}
    ...
    An ideal reactive system conforms to ACID 2 which means:
    \begin{itemize}
    ...
    In order to achieve such a system design, events should be considered first in the design rather then domain.
    Verb first rather than nouns, what happened vs what exists, immutable fact vs cumulative knowledge.

    \subsection{Microservices}
    Once upon a time, the whole software which, an information system for example, was a big monolith, one unit of
    deployment which had only
    ??

    \subsection{Stream processing \cite{flink}}
